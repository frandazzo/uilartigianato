...
@Component
public class DelgaValidatorWithImpersonation  implements DomainClassValidator  {
    ...
    public String validate(AEntity elem) throws Exception {
        ...
        User u = rep.getRegionalUserForCompany(d.getCompanyId());
        ...
        if (d.getLid() > 0)
        {
            ...
            //sia lo stesso utente che ha creato la delega oppure il relativo regionale
