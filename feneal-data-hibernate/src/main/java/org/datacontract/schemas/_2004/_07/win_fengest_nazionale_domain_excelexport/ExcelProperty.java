...
/**
 *  ExcelProperty bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ExcelProperty implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ExcelProperty", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localNameTracker) {
            namespace = "http://schemas.datacontract.org/2004/07/WIN.FENGEST_NAZIONALE.DOMAIN.ExcelExport";
    ...
    public static class Factory {
         ...
         */
        public static ExcelProperty parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ExcelProperty object = new ExcelProperty();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ExcelProperty".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ExcelProperty) it.uilwebapp.services.imports.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                    ...
                    object.setPriority(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            content));
