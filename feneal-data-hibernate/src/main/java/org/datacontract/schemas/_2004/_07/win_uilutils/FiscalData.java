...
/**
 *  FiscalData bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class FiscalData implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Nazione
     */
    protected java.lang.String localNazione;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localNazioneTracker = false;
    ...
    public boolean isNazioneSpecified() {
        return localNazioneTracker;
    }
     ...
     * @param param Nazione
     */
    public void setNazione(java.lang.String param) {
        localNazioneTracker = true;

        this.localNazione = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":FiscalData", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "FiscalData", xmlWriter);
            }
        }
        ...
        if (localNazioneTracker) {
            namespace = "http://schemas.datacontract.org/2004/07/WIN.UILUTILS";
            writeStartElement(null, namespace, "Nazione", xmlWriter);

            if (localNazione == null) {
                // write the nil attribute
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "nil", "1",
                    xmlWriter);
            } else {
                xmlWriter.writeCharacters(localNazione);
            }
    ...
    public static class Factory {
         ...
         */
        public static FiscalData parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            FiscalData object = new FiscalData();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"FiscalData".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (FiscalData) it.uilwebapp.services.imports.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://schemas.datacontract.org/2004/07/WIN.UILUTILS",
                            "Nazione").equals(reader.getName())) ||
                        new javax.xml.namespace.QName("", "Nazione").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if (!"true".equals(nillableValue) &&
                        ...
                        object.setNazione(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                content));
                    } else {
                        reader.getElementText(); // throw away text nodes if any.
                    }
