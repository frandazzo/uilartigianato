...
/**
 *  CalcolaDatiFiscali bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CalcolaDatiFiscali implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://uilwebapp.it/services",
            "CalcolaDatiFiscali", "ns5");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":CalcolaDatiFiscali", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "CalcolaDatiFiscali", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CalcolaDatiFiscali parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CalcolaDatiFiscali object = new CalcolaDatiFiscali();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CalcolaDatiFiscali".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CalcolaDatiFiscali) it.uilwebapp.services.imports.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://uilwebapp.it/services", "codiceFiscale").equals(
                            reader.getName())) ||
                        new javax.xml.namespace.QName("", "codiceFiscale").equals(
                            reader.getName())) {
