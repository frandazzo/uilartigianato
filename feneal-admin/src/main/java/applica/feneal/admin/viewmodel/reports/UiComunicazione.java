...
public class UiComunicazione {
    ...
    public void setCommCategoria(String commCategoria) {
        this.commCategoria = commCategoria;
    }

    public String getCommCategoria() {
        return commCategoria;
    }
