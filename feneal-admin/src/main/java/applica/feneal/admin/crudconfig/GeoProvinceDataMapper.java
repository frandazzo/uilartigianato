...
/**
 * Created by fgran on 10/05/2016.
 */
@Component
public class GeoProvinceDataMapper extends SimplePropertyMapper {
            ...
            if (isRelation(formField)) {
                ...
                if (listType.isAssignableFrom(TypeUtils.getRawClassFromGeneric(formField.getDataType()))) {
                    ...
                    for (String id : requestValueArray) {
                        repository.get(Integer.valueOf(id)).ifPresent(entities::add);
                    }
                    ...
                    if (StringUtils.hasLength(relatedId)) {
                        relatedEntity = (Entity) repository.get(Integer.valueOf(relatedId)).orElseGet(() -> null);
                    }
