...
public class ReportTotalController {
    ...
    @RequestMapping(value="/total/report", method = RequestMethod.POST)
...
//                    .putParam(Params.FORM_COLUMN, "  ");
            ...
            response.setTitle("Report Totale");
