...
@Controller
@RequestMapping("/importDatiUnc")
public class ImportDatiUncController {
    ...
    public void getQuoteTemplate(HttpServletResponse response) {
        try {
            ...
            InputStream is = getClass().getResourceAsStream("/templates/templateProvenienzaUnc.xlsx");
...
//            form.setData(data);
            ...
            response.setTitle("Importazione Dati Unc");
