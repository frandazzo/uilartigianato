...
define([
    ...
    var RepositoryServiceFactory = core.AObject.extend({
        ...
        searchDocumenti: function(searchParams){
            var route = BASE + "documentiazienda/report" ;
    ...
    var ReportDocumentiAziendaAppView = fviews.FormAppView.extend({
        ctor: function(formService) {
            ReportDocumentiAziendaAppView.super.ctor.call(this, formService);
            ...
            self.formView.on("submit", function(){
                ...
                svc.on("load", function(response){
                    ...
                    var reportResultsConfigurer = new resultsConfigurer.ReportUiConfigurer(grid, "documentiAzienda");
        ...
        initGrid : function(responseData){
            ...
            var grid = $('#reportContainer').dxDataGrid({
                ...
                columns:[
                    ...
                    { dataField:"aziendaRagioneSociale", fixed :true, visible : true, visibleIndex: 0,
                        cellTemplate: function (container, options) {

                            $("<a />")
                                .text(options.data.aziendaRagioneSociale)
                        ...
                        calculateCellValue: function (data) {
                            return data.aziendaRagioneSociale;
                        }
              ...
              /*  stateStoring: {
                    enabled: true,
                    type: "localStorage",
                    storageKey: "reportdocumentiazienda"
                },*/
                paging:{
                    pageSize: 35
                },
        ...
        getBreadcrumbItems: function() {
            ...
            return [
                ...
                {
                    label: "Report documenti azienda"
    ...
    exports.ReportDocumentiAziendaAppView = ReportDocumentiAziendaAppView;
