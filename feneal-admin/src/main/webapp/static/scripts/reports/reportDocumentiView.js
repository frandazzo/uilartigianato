...
define([
    ...
    var RepositoryServiceFactory = core.AObject.extend({
        ...
        searchDocumenti: function(searchParams){
            var route = BASE + "documenti/report" ;
    ...
    var ReportDocumentiAppView = fviews.FormAppView.extend({
        ctor: function(formService) {
            ReportDocumentiAppView.super.ctor.call(this, formService);
            ...
            self.formView.on("submit", function(){
                ...
                var svc = factory.searchDocumenti(data);
                ...
                svc.on("load", function(response){
                    ...
                    var reportResultsConfigurer = new resultsConfigurer.ReportUiConfigurer(grid, "documenti");
        ...
        initGrid : function(responseData){
            ...
            var grid = $('#reportContainer').dxDataGrid({
                ...
                columns:[
                    ...
                    { dataField:"docData", visible : true, dataType:'date'},
                    { dataField:"docTipoDocumento", visible : true, visibleIndex: 5},
                    { dataField:"docCollaboratore", visible : true},
                    { dataField:"docProvince", visible : false},
                    { dataField:"docCategoria", visible : true, caption: "Proprietario"},
                ...
                summary: {
                    totalItems: [{
                        ...
                        customizeText: function(data) {
                            return "Documenti trovati: " + data.value;
                        }
                    }]
                },
                // columnChooser: {
    ...
    exports.ReportDocumentiAppView = ReportDocumentiAppView;
