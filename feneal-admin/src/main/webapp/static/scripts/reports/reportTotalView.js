...
define([
    ...
    var RepositoryServiceFactory = core.AObject.extend({
        ...
        searchTotal: function(searchParams){
            var route = BASE + "total/report" ;
    ...
    var ReportTotalAppView = fviews.FormAppView.extend({
        ctor: function(formService) {
            ReportTotalAppView.super.ctor.call(this, formService);
            ...
            self.formView.on("submit", function(){
                ...
                var svc = factory.searchTotal(data);
        ...
        initGrid : function(responseData){
            ...
            var grid = $('#reportContainer').dxDataGrid({
                ...
                columns:[
                    ...
                    { dataField:"tipo", visible : true, visibleIndex: 0 },
    ...
    exports.ReportTotalAppView = ReportTotalAppView;
