...
define([
    ...
    var RepositoryServiceFactory = core.AObject.extend({
        ...
        searchProvBil: function(searchParams){
            var route = BASE + "provbil/report" ;
    ...
    var ReportProvBilAppView = fviews.FormAppView.extend({
        ctor: function(formService) {
            ReportProvBilAppView.super.ctor.call(this, formService);
            ...
            self.formView.on("submit", function(){
                ...
                var svc = factory.searchProvBil(data);
        ...
        getBreadcrumbItems: function() {
            ...
            return [
                ...
                {
                    label: "Report provenienza Bilaterale"
    ...
    exports.ReportProvBilAppView = ReportProvBilAppView;
