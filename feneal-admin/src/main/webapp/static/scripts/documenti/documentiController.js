...
define([
    ...
    "documenti/documentiView"], function(core, fmodel, fviews, fcontrollers, views) {
    ...
    var DocumentiController = fcontrollers.Controller.extend({
        ctor: function(){
            DocumentiController.super.ctor.call(this);
        ...
        createGridView: function(params) {
            return new views.DocumentiCrudGridAppView(this.gridService, params.workerId);
        },
        ...
        createFormView: function(params) {
            ...
            if(params.dialog == 1) {
                ...
                view = new views.DocumentiCrudFormAppView(this.formService, documentId, workerId);
