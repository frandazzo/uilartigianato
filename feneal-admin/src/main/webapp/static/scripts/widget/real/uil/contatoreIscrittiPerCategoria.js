...
define([
    ...
    var Contatore = widgetManager.DashboardWidget.extend({
        ctor:function(widgetName, widgetParams){
            ...
            if (!this.mese){
                var mDefault = $(".contatore-iscritti-container").find('input[name="hidden-month"]').val();
                this.mese = mDefault;
            }
        ...
        prepareWidget: function(){
            ...
            service.set("url",BASE + "widget/real/contatoreIscrittiPerCategoria/getData");
        ...
        renderHtmlForm : function(editPanel, params){
            ...
            // var monthSelect = $(".contatore-iscritti-container").find('div.param-fields-container').find('select[name="month"]').clone();
            //
            // if (month)
