...
!function (t) {
    function e(t, e) {
        ...
        return e.css({
            transition: n + "s right, " + n + "s left, " + n + "s top, " + n + "s bottom, " + n + "s height, " + n + "s width"
        }), !0
    }
        ...
        l = (t(window).width(), {
            init: function (n) {
                return this.each(function () {
                    ...
                    var s = t("body"),
                        c = t(window),
                        u = t("<div/>").addClass(i).addClass(r.options.dialogClass);
                    ...
                    if (u.append(h), r.options.buttons.length) {
                        var f = t("<div></div>").addClass(i + "-footer"),
                            v = t("<div></div>").addClass(i + "-footer-buttonset");
                        f.append(v), t.each(r.options.buttons, function (e, n) {
                            var o = t('<a href="#" class="btn"></a>');
                            o.attr({
                                id: n.id,
                                "class": n.buttonClass
                            }), o.html(n.html), o.click(function (t) {
            ...
            minimize: function () {
                return this.each(function () {
                    ...
                    if (e && (!t.isFunction(e.options.beforeMinimize) || e.options.beforeMinimize(e) !== !1)) {
                        var n = e.closest("." + i),
                            o = n.find(".dockmodal-header").outerHeight();
            ...
            refreshLayout: function () {
                ...
                t.each(t("." + i).toArray().reverse(), function () {
                    var o = t(this),
                        l = o.find("." + i + "-body > div").data("dockmodal");
                    (!o.hasClass("popped-out") || o.hasClass("minimized")) && (e += l.options.gutter, o.css({
                        right: e + "px"
                    }), e += o.hasClass("minimized") ? l.options.minimizedWidth : l.options.width, e > n ? o.hide() : setTimeout(function () {
                        o.show()
    ...
    function (t, e) {
        t.fn.adminpanel = function (n) {
            var o = {
                ...
                s = n.preserveGrid,
                c = i.find(".panel"),
                u = "panel-settings_" + location.pathname,
                p = "panel-positions_" + location.pathname,
                d = localStorage.getItem(u),
            ...
            var f = {
                ...
                createMobileControls: function () {
                    var e = c.find(".panel-controls"),
                        n = {};
                    t.each(e, function (e, o) {
                        var i = t(o),
                            l = t(o).parents(".panel").attr("id"),
                            r = i.width(),
                            a = i.siblings(".panel-title").width(),
                            s = (i.parent(".panel-heading").width(), r + a);
                        n[l] = s
                    }), console.log(n), t.each(n, function (e, n) {
                        var o = t("#" + e),
                            i = o.width() - 75,
                            l = o.find(".panel-controls");
                        if (a === !0 || n > i) {
                ...
                applySettings: function () {
                    var e = localStorage.getItem(u),
                        n = JSON.parse(e),
                        o = "panel-primary panel-success panel-info panel-warning panel-danger panel-alert panel-system panel-dark panel-default";
                ...
                createControls: function () {
                    var e = '<span class="panel-controls"></span>',
                        n = '<a href="#" class="panel-control-title"></a>',
                        o = '<a href="#" class="panel-control-color"></a>',
                        i = '<a href="#" class="panel-control-collapse"></a>',
                        l = '<a href="#" class="panel-control-fullscreen"></a>',
                        r = '<a href="#" class="panel-control-remove"></a>',
                        a = '<a href="#" class="panel-control-callback"></a>',
                        s = '<a href="#" class="panel-control-dockable" data-toggle="popover" data-content="panelDockContent();"></a>',
                        u = '<a href="#" class="panel-control-expose"></a>',
                        p = '<a href="#" class="panel-control-loader"></a>';
                    c.each(function (c, d) {
                        var h = t(d),
                            f = h.children(".panel-heading");
                        t(e).appendTo(f);
                        var v = h.attr("data-panel-title"),
                            m = h.attr("data-panel-color"),
                            g = h.attr("data-panel-collapse"),
                            b = h.attr("data-panel-fullscreen"),
                            y = h.attr("data-panel-remove"),
                            C = h.attr("data-panel-callback"),
                            w = h.attr("data-panel-dockable"),
                            x = h.attr("data-panel-expose"),
                            k = h.attr("data-panel-loader");
                        if (!k) {
                ...
                controlHandlers: function () {
                    var o = t(this),
                        l = (o.attr("class"), o.parents(".panel")),
                        a = l.children(".panel-heading"),
                        s = l.find(".panel-title"),
                        c = function () {
                            var t = function () {
                            ...
                            if (l.find(".panel-editbox").length) t();
                            else {
                        ...
                        u = function () {
                            ...
                            o.on("click", "> span", function () {
                                var e = t(this).data("panel-color"),
                                    o = "panel-primary panel-info panel-success panel-warning panel-danger panel-alert panel-system panel-dark panel-default panel-white";
                ...
                modifySettings: function () {
                    ...
                    c.each(function (n, o) {
                        var i = t(o),
                            l = {},
                            r = (i.attr("id"), i.children(".panel-heading").find(".panel-title").text(), i.hasClass("panel-collapsed") ? 1 : 0, i.is(":hidden") ? 1 : 0, i.data("panel-color"));
                        l.id = i.attr("id"), l.title = i.children(".panel-heading").find(".panel-title").text(), l.collapsed = i.hasClass("panel-collapsed") ? 1 : 0, l.hidden = i.is(":hidden") ? 1 : 0, l.color = r ? r : null, e.push({
                            panel: l
                        })
                    });
    ...
    function (t, e) {
        ...
        function a(t) {
            ...
            return t = e.extend({}, f, t), t.buttons || (t.buttons = {}), t.backdrop = t.backdrop ? "static" : !1, n = t.buttons, o = l(n), r(n, function (t, i, l) {
                if (e.isFunction(i) && (i = n[t] = {
                        callback: i
                    }), "object" !== e.type(i)) throw new Error("button with key " + t + " must be an object");
    ...
    "undefined" != typeof ko && ko.bindingHandlers && !ko.bindingHandlers.multiselect && (ko.bindingHandlers.multiselect = {
        init: function (o, i, l) {
            var r = l().selectedOptions,
                a = ko.utils.unwrapObservable(i());
        ...
        update: function (n, o, i) {
            var l = i().options,
                r = t(n).data("multiselect"),
                a = ko.utils.unwrapObservable(o());
        ...
        buildDropdownOptions: function () {
            this.$select.children().each(t.proxy(function (e, n) {
                ...
                var n = t(e.target),
                    o = n.prop("checked") || !1,
                    i = n.val() === this.options.selectAllValue;
                ...
                var l = n.val(),
                    r = this.getOptionByValue(l),
                    a = t("option", this.$select).not(r),
                    s = t("input", this.$container).not(n);
                ...
                if (e.shiftKey) {
                    ...
                    if (i) {
                        var l = n.closest("li").siblings('li[class="active"]:first'),
                            r = n.closest("li").index(),
                            a = l.index();
                ...
                var n = t(e.target).parent(),
                    o = n.nextUntil("li.multiselect-group"),
                    i = !0,
                    l = o.find("input");
                l.each(function () {
        ...
        createOptionValue: function (e) {
            ...
            var o = this.options.label(e),
                i = n.val(),
                l = this.options.multiple ? "checkbox" : "radio",
        ...
        select: function (e, n) {
            ...
            for (var o = 0; o < e.length; o++) {
                var i = e[o];
                if (null !== i && void 0 !== i) {
                    var l = this.getOptionByValue(i),
                        r = this.getInputByValue(i);
        ...
        selectAll: function (e) {
            var e = "undefined" == typeof e ? !0 : e,
                ...
                i = n.length,
                l = o.length;
            if (e ? (o.prop("checked", !0), t("li:not(.divider):not(.disabled)", this.$ul).filter(":visible").addClass(this.options.selectedClass)) : (n.prop("checked", !0), t("li:not(.divider):not(.disabled)", this.$ul).addClass(this.options.selectedClass)), i === l || e === !1) t("option:enabled", this.$select).prop("selected", !0);
            else {
        ...
        dataprovider: function (e) {
            ...
            t.each(e, function (e, r) {
                var a;
                t.isArray(r.children) ? (i++, a = t("<optgroup/>").attr({
                    label: r.label || "Group " + i
                }), n(r.children, function (e) {
        ...
        updateSelectAll: function () {
            if (this.hasSelectAll()) {
                var e = t("li:not(.multiselect-item):not(.filter-hidden) input:enabled", this.$ul),
                    ...
                    i = t("li." + this.options.selectAllValue, this.$ul),
                    l = i.find("input");
        ...
        t.fn.extend({
            ...
            smoothScroll: function (n, o) {
                if (n = n || {}, "options" === n) return o ? this.each(function () {
                    var e = t(this),
                        n = t.extend(e.data("ssOpts") || {}, o);
                    t(this).data("ssOpts", n)
                }) : this.first().data("ssOpts");
                var i = t.extend({}, t.fn.smoothScroll.defaults, n),
                    l = t.smoothScroll.filterPath(location.pathname);
                return this.unbind("click.smoothscroll").bind("click.smoothscroll", function (n) {
                    var o = this,
                        r = t(this),
                        a = t.extend({}, i, r.data("ssOpts") || {}),
                        s = i.exclude,
                        c = a.excludeWithin,
                        u = 0,
                        p = 0,
                        d = !0,
                        h = {},
                        f = location.hostname === o.hostname || !o.hostname,
                        v = a.scrollTarget || t.smoothScroll.filterPath(o.pathname) === l,
                        m = e(o.hash);
            ...
            "number" == typeof e ? (i = t.extend({
                link: null
            }, t.fn.smoothScroll.defaults, o), r = e) : (i = t.extend({
                link: null
...
JSON || (JSON = {}),
            ...
            switch (s && "object" == typeof s && "function" == typeof s.toJSON && (s = s.toJSON(t)), "function" == typeof rep && (s = rep.call(e, t, s)), typeof s) {
                ...
                case "object":
                    ...
                    if (rep && "object" == typeof rep)
                        for (l = rep.length, n = 0; l > n; n += 1) "string" == typeof rep[n] && (o = rep[n], i = str(o, s), i && r.push(quote(o) + (gap ? ": " : ":") + i));
                    else
                        for (o in s) Object.prototype.hasOwnProperty.call(s, o) && (i = str(o, s), i && r.push(quote(o) + (gap ? ": " : ":") + i));
                    return i = 0 === r.length ? "{}" : gap ? "{\n" + gap + r.join(",\n" + gap) + "\n" + a + "}" : "{" + r.join(",") + "}", gap = a, i
            }
        }
    ...
    function (t) {
        ...
        function o(t, n) {
            ...
            for (var r = 0; r < i.length; ++r) {
                ...
                for (var a = 0; a < l.length; ++a)
                    if (o = l[a], o += 0 === a ? n : n.charAt(0).toUpperCase() + n.substr(1), e(t[o])) return t[o]
            }
            return void 0
        }
        ...
        var i = [
            ...
            l = ["", "o", "ms", "moz", "webkit", "webkitCurrent"],
            r = navigator.userAgent,
            a = o("fullscreenEnabled"),
            s = -1 !== r.indexOf("Android") && -1 !== r.indexOf("Chrome"),
            c = !s && e(o("fullscreenElement")) && (!e(a) || a === !0),
            u = t.fn.jquery.split("."),
            p = parseInt(u[0]) < 2 && parseInt(u[1]) < 7,
            d = function () {
        ...
        n(f, d, {
            ...
            __delegateKeydownHandler: function () {
                ...
                var n = p ? e.data("events") : t._data(document).events,
                    o = n.keydown;
            ...
            return e = t.extend({
                ...
                overflow: e.overflow
            }, delete e.overflow, n && t.fullscreen.open(n, e), this
        }
    }(jQuery),
    function (t, e) {
        "use strict";
        ...
        function i(t) {
            ...
            if (e.horizontal) {
                ...
                i > e.handleBounds.right && (i = e.handleBounds.right), n = {
                    left: i
                }
            } else {
                ...
                r > e.handleBounds.bottom && (r = e.handleBounds.bottom), n = {
                    top: r
                }
            }
            e.$handle.css(n)
        ...
        function l(t) {
            ...
            var e = t.data,
                n = t.originalEvent,
                o = e.$track.offset(),
                i = "undefined" != typeof n.targetTouches ? n.targetTouches[0] : null,
                l = i ? i.pageX : t.clientX,
                r = i ? i.pageY : t.clientY;
        ...
        function r(t) {
            ...
            var e = t.data,
                n = t.originalEvent,
                o = "undefined" != typeof n.targetTouches ? n.targetTouches[0] : null,
                i = o ? o.pageX : t.clientX,
                l = o ? o.pageY : t.clientY;
        ...
        function s(t) {
            ...
            var e = t.data,
                ...
                o = 0,
                i = 0,
                l = "undefined" != typeof n.targetTouches ? n.targetTouches[0] : null,
                r = l ? l.pageX : t.clientX,
                a = l ? l.pageY : t.clientY;
                    ...
                    return t(this).each(function () {
                        ...
                        if (e) {
                            ...
                            if (e.horizontal) {
                                ...
                                l = a * e.ratio, r = e.scrollWidth <= e.frameWidth, n = {
                                    width: e.frameWidth
                                }, o = {
                                    width: e.trackWidth,
                                ...
                                l = s * e.ratio, r = e.scrollHeight <= e.frameHeight, n = {
    ...
    function () {
        ...
        h.reduce = h.foldl = h.inject = function (t, e, n, o) {
            null == t && (t = []), e = f(e, o, 4);
            var i, l = t.length !== +t.length && h.keys(t),
                r = (l || t).length,
                a = 0;
            ...
            if (null == t) return !0;
            e = h.iteratee(e, n);
            var o, i, l = t.length !== +t.length && h.keys(t),
                r = (l || t).length;
            for (o = 0; r > o; o++)
                if (i = l ? l[o] : o, !e(t[i], i, t)) return !1;
            return !0
            ...
            var o, i, l = t.length !== +t.length && h.keys(t),
                r = (l || t).length;
            for (o = 0; r > o; o++)
                if (i = l ? l[o] : o, e(t[i], i, t)) return !0;
            return !1
        ...
        var y = function (t, e, n, o) {
            ...
            if ("[object Array]" === i) {
                if (c = t.length, u = c === e.length)
                    for (; c-- && (u = y(t[c], e[c], n, o)););
            } else {
                var p, d = h.keys(t);
                if (c = d.length, u = h.keys(e).length === c)
                    for (; c-- && (p = d[c], u = h.has(e, p) && y(t[p], e[p], n, o)););
            }
